...
static ABOUT: &str = help_about!("get_relays.md");

const USAGE: &str = help_usage!("get_relays.md");
...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    for path in name_args {
        print!("{}{}", get_relays(path, &suffix), line_ending);
    }
...
fn get_relays(fullname: &str, suffix: &str) -> String {
