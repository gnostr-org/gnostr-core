...
static ABOUT: &str = help_about!("pubkey_to_bech32.md");

const USAGE: &str = help_usage!("pubkey_to_bech32.md");
...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    for path in name_args {
        print!("{}{}", pubkey_to_bech32(path, &suffix), line_ending);
    }
...
fn pubkey_to_bech32(fullname: &str, suffix: &str) -> String {
