...
static ABOUT: &str = help_about!("keypair.md");

const USAGE: &str = help_usage!("keypair.md");
...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    for path in name_args {
        print!("{}{}", keypair(path, &suffix), line_ending);
    }
...
fn keypair(fullname: &str, suffix: &str) -> String {
