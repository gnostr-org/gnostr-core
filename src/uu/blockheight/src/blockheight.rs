...
static ABOUT: &str = help_about!("blockheight.md");

const USAGE: &str = help_usage!("blockheight.md");
...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    for path in name_args {
        print!("{}{}", blockheight(path, &suffix), line_ending);
    }
...
fn blockheight(fullname: &str, suffix: &str) -> String {
