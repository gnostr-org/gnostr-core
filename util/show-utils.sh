...
expr factor false fmt fold get_relays git hashsum head join keypair legit link ln ls mkdir mktemp more mv nl od paste post post_event printenv
printf privkey_to_bech32 ptx pwd readlink realpath reflog rm rmdir seq shred shuf sleep sort split sum tac tail tee template
